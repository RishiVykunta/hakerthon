          ...
          {user ? (
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                ...
                <div className="text-[10px] text-amber-700 font-semibold capitalize flex items-center gap-1 justify-end mt-1">
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                className="px-4 py-2 rounded-xl text-xs font-bold bg-amber-500 text-slate-950 hover:bg-amber-400 transition-all shadow-md shadow-amber-500/20 hover:scale-[1.02]"
              >
                Supervisor Login
              </Link>
              <Link
                href="/login?role=worker"
                className="px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-all"
              >
                Worker Portal
              </Link>
            </div>
